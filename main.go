...
func main() {
	...
	flag.StringVar(&config.BinAssetsPackage, "binassets-package", "github.com/JeremyOT/binassets/binassets", "Overrides the import path for generated files to support vendoring.")
	flag.Parse()
	if config.Package == "" {
